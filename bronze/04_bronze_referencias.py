...
for tabela, comentario in [
    ("voebem.bronze.aerodromos",
     "Bronze - cadastro de aeródromos públicos da ANAC, como chegou. Chave: código ICAO (OACI). "
     "Cobre apenas aeródromos brasileiros - aeroportos estrangeiros do VRA não estão aqui."),
    ("voebem.bronze.empresas_nacionais",
     "Bronze - cadastro de empresas aéreas NACIONAIS da ANAC, como chegou. Chave: código ICAO. "
     "Não unir com empresas_estrangeiras nesta camada: a união é feita na silver."),
    ("voebem.bronze.empresas_estrangeiras",
     "Bronze - cadastro de empresas aéreas ESTRANGEIRAS autorizadas a operar no Brasil, como chegou. "
     "Chave: código ICAO. Cadastro separado do nacional na origem, mantido separado no bronze."),
    ("voebem.bronze.codigos_operacao",
     "Bronze - seed table curada a partir da página de descrição de variáveis da ANAC. "
     "Traduz código_di e código_tipo_linha para descrição em português."),
]:
